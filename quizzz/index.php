    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <div class='card'>
            ...
            <form action='' method='post'>
                ...
                <input type='checkbox' name='selected_option' value='1'><?php echo $row["odpowiedz1"]; ?></button>
                <input type='checkbox' name='selected_option' value='2'><?php echo $row["odpowiedz2"]; ?></button>
                <input type='checkbox' name='selected_option' value='3'><?php echo $row["odpowiedz3"]; ?></button>
                <input type='checkbox' name='selected_option' value='4'><?php echo $row["odpowiedz4"]; ?></button>
            </form>
        </div>
        <?php
